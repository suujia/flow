...
/*GetOK list the spot operations
...
func (o *GetOK) WithPayload(payload []*models.Spots) *GetOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get o k response
func (o *GetOK) SetPayload(payload []*models.Spots) {
	o.Payload = payload
}
...
func (o *GetOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
	...
	payload := o.Payload
	if payload == nil {
		payload = make([]*models.Spots, 0, 50)
	}
